...
module.exports = function ({ getItemTypeAndModelInformationUpdateData, moment } = {}) {
    ...
    return async (req, res) => {
        ...
        const dbData = await getItemTypeAndModelInformationUpdateData(firstName, lastName, startOfCurrentWeek, endOfCurrentWeek);
