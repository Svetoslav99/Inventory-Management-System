...
module.exports = function ({ getItemTypeAndModelInformationDeleteData, moment } = {}) {
    ...
    return async (req, res) => {
        ...
        const dbData = await getItemTypeAndModelInformationDeleteData(firstName, lastName, startOfCurrentWeek, endOfCurrentWeek);
