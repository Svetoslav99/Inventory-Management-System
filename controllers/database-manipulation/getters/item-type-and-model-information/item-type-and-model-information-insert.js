...
module.exports = function ({ getItemTypeAndModelInformationInsertData, moment } = {}) {
    ...
    return async (req, res) => {
        ...
        const dbData = await getItemTypeAndModelInformationInsertData(firstName, lastName, startOfCurrentWeek, endOfCurrentWeek);
