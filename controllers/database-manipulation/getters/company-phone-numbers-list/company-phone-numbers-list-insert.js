...
module.exports = function ({ getCompanyPhoneNumbersListInsertData, moment } = {}) {
    ...
    return async (req, res) => {
        ...
        const dbData = await getCompanyPhoneNumbersListInsertData(firstName, lastName, startOfCurrentWeek, endOfCurrentWeek);
