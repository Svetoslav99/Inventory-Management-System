...
module.exports = function ({ getCompanyPhoneNumbersListUpdateData, moment } = {}) {
    ...
    return async (req, res) => {
        ...
        const dbData = await getCompanyPhoneNumbersListUpdateData(firstName, lastName, startOfCurrentWeek, endOfCurrentWeek);
