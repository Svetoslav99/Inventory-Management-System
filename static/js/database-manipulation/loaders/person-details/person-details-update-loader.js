...
const role = $('#role');
const deleteButton = $('#update-person');
...
const requestData = () => new Promise(async (resolve, reject) => {
    ...
    if (idValue === "" || firstNameValue === "" || lastNameValue === "" || streetNameValue === "" || streetDetailsValue === "" ||
        ...
        try {
            const response = await fetch(`/api/database-manipulation-homepage/person-details-update?
            id=${idValue}
